                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            @endauth
                            <a href="/contact"
                               class="{{ request()->is('/contact') ? 'bg-gray-900 text-black' : 'text-black' }} hover:bg-white hover:text-gray-500 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        @guest
                            <div class="ml-3">
                                <a href="/register"
                                   class="{{ request()->is('/register') ? 'bg-gray-900 text-black' : 'text-black' }} hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
                                <a href="/login"
                                   class="{{ request()->is('/login') ? 'bg-gray-900 text-black' : 'text-black' }} hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log
                                    In</a>
                            </div>
                        @endguest
                    </div>

        ...
        <div class="mx-auto max-w-7xl py-0 lg:py-6 sm:px-6 lg:px-8">
            <div class="bg-white">
                ...
                <div class="mx-auto max-w-2xl px-4 py-3 sm:px-6 lg:py-4 lg:max-w-7xl lg:px-8">
                    ...
                    <h2 class="text-2xl font-normal tracking-tight text-gray-900">Restaurants and Bars in Toronto</h2>
                    <p class="text-sm text-gray-500 mt-2">Here you can find Toronto's best dog-friendly restaurants and bars.</p>
                    @endif

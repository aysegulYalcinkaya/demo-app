        ...
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="bg-white">
                <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
                    <form action="{{ route('cafes.search') }}" method="GET">
                ...
                <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
                    <h2 class="text-2xl font-normal tracking-tight text-gray-900">Cafes, Bakeries, and Coffee shops in Toronto</h2>
                    <p class="text-sm text-gray-500 mt-2"><i>"Brew let the dogs in"</i>. Here you can find Toronto's best dog-friendly cafes, bakeries, and coffee shops.</p>
